...
function NetProfitCard() {
  return (
    <section className="bg-white border border-outline-variant rounded-xl p-md flex flex-col gap-xs">
      <span className="font-label-md text-label-md text-on-surface-variant uppercase tracking-wider">Net Profit</span>
