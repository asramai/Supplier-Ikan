...
function StatusChips() {
  const statuses = [
    { label: 'Proses (12)', bgColor: 'bg-[#E8F5E9]', textColor: 'text-[#28A745]', dotColor: 'bg-[#28A745]' },
    { label: 'Siap (5)', bgColor: 'bg-[#F0F0F0]', textColor: 'text-[#6C757D]', dotColor: 'bg-[#6C757D]' },
    { label: 'Menunggu Pembayaran (2)', bgColor: 'bg-[#FDEDEC]', textColor: 'text-[#DC3545]', dotColor: 'bg-[#DC3545]' },
  ]
